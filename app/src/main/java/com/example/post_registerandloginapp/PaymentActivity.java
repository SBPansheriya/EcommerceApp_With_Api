...
public class PaymentActivity extends Activity implements PaymentResultWithDataListener, ExternalWalletListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        razorname = findViewById(R.id.razorname);
        razorprice = findViewById(R.id.razorprice);
        ...
        razorname.setText(""+name);
        razorprice.setText("IND "+""+price);
    ...
    public void startPayment() {
        ...
        etApiKey.setText("rzp_test_s5jJfd7dPGWprz");
        ...
        if (!TextUtils.isEmpty(etCustomOptions.getText().toString())) {
            ...
            try {
                ...
                preFill.put("contact", "9512052570");
